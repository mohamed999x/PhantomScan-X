...
def banner(m):
    ...
    banner_to_print  = Bold+G + banner.format(Name=f"{end+R}QrlJacker-Framework {end+B}By {Bold}@BnB7r -{M} V{v+end+Bold+G}",
                                      Description=f"{end+C}Attack vector By Mohamed Abdelhameed{end+Bold+G}",
